namespace ReportesMarzzan
{
    ...
    public partial class ReporteCuerpoPedidoInterno : Telerik.Reporting.Report
    {
        ...
        public void InitReport(List<long> ids,string UsuarioImpresion)
        {
            ...
            List<DetallePedido> detalle = (from P in dc.DetallePedidos
            ...
            this.reporteDetallePedido1.DataSource = from D in detalle
                                                    orderby D.objCabecera.Nro , D.OrdenInterno 
                                                    select D;
            ...
            this.ReportParameters["UsuarioImpresion"].Value = UsuarioImpresion;
