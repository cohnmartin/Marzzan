<%@ Page Language="C#" Theme="SkinMarzzan" AutoEventWireup="true" CodeFile="GestionEliminacionPedidosLideres.aspx.cs"
    Inherits="GestionEliminacionPedidosLideres" %>
            ...
            <td>
                ...
                <div class="CabeceraContent">
                    <table width="100%" border="0" cellspacing="0" >
                        ...
                        <tr>
                            <td align="right" style="color: #993300; font-family: Sans-Serif; font-size: 11px">
                                <asp:Label SkinID="lblBlue" ID="Label1" runat="server">Revendedor:</asp:Label>
                            </td>
                            <td align="left" style="width: 300px;" colspan="4">
                                <telerik:RadComboBox ID="cboConsultores" runat="server" Skin="WebBlue" Width="100%"
                                    AllowCustomText="true" EmptyMessage="Cualquier Revendedor" CloseDropDownOnBlur="true"
                                    MarkFirstMatch="true">
                        ...
                        <tr>
                            ...
                            <td align="left" valign="middle" style="width: 300px;" colspan="4">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="btnConsultar" runat="server" Text="Consultar" SkinID="btnBasic" OnClick="btnConsultar_Click"
                                    Mensaje="Buscando Pedido..." />
                            </td>
                        </tr>
                        <tr>
                            <td style="color: #993300; font-family: Sans-Serif; font-size: 11px" colspan="5">
                                    ...
                                    <ContentTemplate>
                                        <telerik:RadGrid ID="GrillaResultados" runat="server" GridLines="None" Skin="Vista"
                                            ...
                                            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IdCabeceraPedido" ClientDataKeyNames="IdCabeceraPedido"
                                                ...
                                                NoMasterRecordsText="No se encontró el pedido solicitado o el mismo ya fue procesado">
