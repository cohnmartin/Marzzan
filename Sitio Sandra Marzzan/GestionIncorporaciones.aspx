<%@ Page Language="C#" Theme="SkinMarzzan" AutoEventWireup="true" CodeFile="GestionIncorporaciones.aspx.cs" Inherits="GestionIncorporaciones" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Gestión de Incorporaciones</title>
...
<script type="text/javascript">
    function ControlarCarga() {
        ...
        if ($find('<%= cboPromociones.ClientID %>').get_value() == "") {
            ...
            tooltipo.set_text("Debe Seleccionar el tipo de incorporación que desea configurar");
            tooltipo.show();
            return false;
...
<body style="background-image: url(Imagenes/repetido.jpg); margin-top:1px; background-repeat:repeat-x;background-color:White;"  >
                                    ...
                                    <tr>
                                        <td align="center" style="height: 25px; background: url('imagenes/sprite_webBlue.gif') 0  -300px repeat-x">
                                            <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Size="14pt" Font-Names="Sans-Serif"
                                                ForeColor="Gray" Text="Gestión de Incorporaciones" Width="378px"></asp:Label>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="style1">
                                            <tr>
                                                <td style="width: 40%; text-align: right">
                                                    <asp:Label SkinID="lblBlue" ID="lblPromociones" Text="Tipo Incorporación:" runat="server"></asp:Label>
                                                </td>
                                                <td style="height: 25px">
                                                    <telerik:RadComboBox ID="cboPromociones" runat="server" Width="296px" EmptyMessage="Seleccione una Incorporación"
                                                        Skin="WebBlue" AllowCustomText="true" MarkFirstMatch="true" 
                                    ...
                                    <ContentTemplate>
                                        <table cellpadding="1" cellspacing="2" class="style1">
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cboLineas" runat="server" Skin="Vista" Width="250px" OnItemsRequested="cboLineas_ItemsRequested"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadComboBox ID="cboDefiniciones" runat="server" Skin="Vista" Width="250px"
                                                        OnItemsRequested="cboDefiniciones_ItemsRequested" OnClientItemsRequested="ItemsLoaded" />
                                                </td>
                                                <td>
                                                    <asp:Label SkinID="lblBlue" ID="Label2" Text="Cantidad:" runat="server"></asp:Label>
                                                </td>
                                                <td>
                                                     <telerik:RadNumericTextBox ID="txtCantidad" runat="server"
                                                        Value="1" MaxValue="10" MinValue="1" ShowSpinButtons="True"
                                                        Skin="Vista" Width="70px">
  ...
  <script type="text/javascript">
      ...
      function LoadFragancias(combo, eventarqs) {
          ...
          var FraganciasCombo = $find("cboFragancias");
          var PresentacionesCombo = $find("cboPresentaciones");
          var cboUndNeg = $find("cboUndNeg");
          var item = eventarqs.get_item();

          if (item.get_index() >= 0) {
              if (cboUndNeg.get_text().indexOf('Promo') < 0 && cboUndNeg.get_text().indexOf('Descuen') < 0)
